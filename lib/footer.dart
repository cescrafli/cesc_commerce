              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 12),
                    _buildInactiveCard(1, 'Mastercard ending in 8831', 'Expires 11/26 • Credit Card', Icons.circle, Colors.orange, 'Set Default'),
                    const SizedBox(height: 15),
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 4),
                              const Text('4242   ••••   ••••   8821', style: TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.bold, letterSpacing: 2)),
                            ],
                          ),
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      padding: const EdgeInsets.symmetric(horizontal: 15),
                                      decoration: BoxDecoration(color: const Color(0xFFF7F8FA), borderRadius: BorderRadius.circular(12), border: Border.all(color: Colors.grey.shade200)),
                                      child: const TextField(obscureText: true, decoration: InputDecoration(border: InputBorder.none, hintText: '•••', prefixIcon: Icon(Icons.lock_outline, size: 18, color: Colors.grey), prefixIconConstraints: BoxConstraints(minWidth: 30)), style: TextStyle(fontSize: 14, letterSpacing: 2)),
                                    ),
                                  ],
                                ),
                              )

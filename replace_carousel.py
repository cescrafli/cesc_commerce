...
pattern = r"class _PromoCarouselState extends State<PromoCarousel> \{.*?class HomeScreen extends StatelessWidget \{"

new_class = '''class _PromoCarouselState extends State<PromoCarousel> {
